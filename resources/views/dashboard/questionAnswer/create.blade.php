    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="m-portlet">
                ...
                <form action="{{ route('questionAnswer.store') }}" method="POST" class="m-form m-form--label-align-right">
                    @csrf
                    <div class="m-portlet__body">
                        <div class="m-form__section m-form__section--first">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" name="question" id="question" value="{{ old('question') }}" class="form-control m-input m-input--air m-input--pill" placeholder=@lang('questionAnswer.create.question')>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" name="question_ar" id="question_ar" value="{{ old('question_ar') }}" class="form-control m-input m-input--air m-input--pill" placeholder=@lang('questionAnswer.create.question_ar')>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="form-group m-form__group col-md-6">
                                    <textarea class="form-control m-input m-input--air m-input--pill" id="answer" name="answer" rows="9">{{ old('answer') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="form-group m-form__group col-md-6">
                                    <textarea class="form-control m-input m-input--air m-input--pill" id="answer_ar" name="answer_ar" rows="9">{{ old('answer_ar') }}</textarea>
                                </div>
                            </div>
