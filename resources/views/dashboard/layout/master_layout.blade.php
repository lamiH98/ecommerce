                                ...
                                <div class="m-stack m-stack--ver m-stack--general">
                                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                        <a href="index.html" class="m-brand__logo-wrapper">
                                            <img alt="" src="{{ asset('design/ecommerce/img/core-img/logo.png') }}" />
                                        </a>
                                    </div>
                                             ...
                                             m-dropdown-persistent="1">
                                                ...
                                                <div class="m-dropdown__wrapper">
                                                    ...
                                                    <div class="m-dropdown__inner">
                                                        <div class="m-dropdown__header m--align-center" style="background: url({{ asset('dashboards/assets/app/media/img/misc/notification_bg.jpg')}}); background-size: cover;">
                                                        ...
                                                        <div class="m-dropdown__header m--align-center" style="background: url({{ asset('dashboards/assets/app/media/img/misc/user_profile_bg.jpg')}}); background-size: cover;">
                                                            <div class="m-card-user m-card-user--skin-dark">
                                                                ...
                                                                <div class="m-card-user__details">
                                                                    ...
                                                                    <span class="m-card-user__name m--font-weight-300">Language: {{ app()->getLocale() == 'en' ? 'English' : 'العربية' }}</span>
                                                        ...
                                                        <div class="m-dropdown__body">
                                                            <div class="m-dropdown__content">
                                                                <ul class="m-nav m-nav--skin-light">
                                                                    ...
                                                                    <li class="m-nav__item">
                                                                        <a href="{{ route('local.change', ['lang' => 'en']) }}" class="m-nav__link">
                                                                            <i class="m-nav__link-icon flaticon-chat-1"></i>
                                                                            <span class="m-nav__link-text">English</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="m-nav__item">
                                                                        <a href="{{ route('local.change', ['lang' => 'ar']) }}" class="m-nav__link">
                                                                            <i class="m-nav__link-icon flaticon-chat-1"></i>
                                                                            <span class="m-nav__link-text">Arabic</span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                        ...
                        <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
                            <div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
                                <span class="m-footer__copyright">
                                    2019 &copy; Made by <a href="#" class="m-link">lami</a>
                                </span>
                            </div>
                        </div>
                    </div>
